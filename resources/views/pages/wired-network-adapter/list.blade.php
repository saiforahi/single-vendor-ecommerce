                                ...
                                <tr class="items" data-href="#">
                                        ...
                                        <div class="logo-name">
                                            <div class="item-logo">
                                                ...
                                                <img src="{{ count($images) > 0 ? $images[0]->getUrl('main_image') : asset('images/dummy-thumbnail') }}"
                                                    ...
                                                    title="{{ $wired_network_adapter->name }}"
                                                    alt="{{ $wired_network_adapter->name }}">
                                    ...
                                    <td class="comp-details">
                                        <div class="table_title"><a
                                                href="{{ route('wired-network-adapter-details', ['id' => $wired_network_adapter->id]) }}">{{ $wired_network_adapter->name }}</a>
                                        </div>
                                        <span class="table_span">
                                            <div class="detail">
                                                <div class="detail__name">Brand:</div>
                                                <div class="detail__value f_brand"> {{ $wired_network_adapter->brand }}
                                                </div>
                                            </div>
                                            <div class="detail">
                                                <div class="detail__name">Model:</div>
                                                <div class="detail__value f_model"> {{ $wired_network_adapter->model }}
                                                </div>
                                            </div>
                                            <div class="detail">
                                                <div class="detail__name">Stock:</div>
                                                <div class="detail__value f_stock"> {{ $wired_network_adapter->product->stock }} </div>
                                            </div>
                                        </span>
                                        {{-- <span class="table_span">
                                    ...
                                    <td class="price">
                                        {{ $wired_network_adapter->product->price }} </td>

                                    <td><a class="btn btn-primary component-btn"
                                            href="{{ route('wired-network-adapter-details', ['id' => $wired_network_adapter->id]) }}"
                                            target="_blank">View
                                            Details</a></td>
                                    <td class="remove"><a class="btn btn-danger component-add-btn" id="p_1"
                                            href="{{ route('add-wired_network_adapter-to-system', ['wired_network_adapter_id' => $wired_network_adapter->id]) }}"><i
