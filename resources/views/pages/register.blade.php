                        ...
                        <form method="POST" action="{{route('register')}}" id="idForm">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <input type="text" class="form-control mb-3" placeholder="Name" name="name" id="name" required>
                                </div>
                                <div class="col-12 col-md-6">
                                    <input type="email" class="form-control mb-3" placeholder="Email" name="email" autocomplete="email" required>
                                </div>
                                {{-- <div class="col-12 col-md-6">
