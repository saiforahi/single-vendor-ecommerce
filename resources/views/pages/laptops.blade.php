                    ...
                    <div class="tab-content mt-5 mt-lg-6" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-content-research" role="tabpanel"
                            ...
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-12 col-md-6"><img class="img-fluid shadow rounded"
                                        src="{!! asset('images/builds/pc-builds.jpg') !!}" alt="Gaming PC"></div>
                                <a href="{!! route('laptop-list', ['type' => 'gaming']) !!}" class="my-4 mb-5 d-block font-weight-bold btn-open"><i
                        ...
                        <div class="tab-pane fade" id="nav-rank-track" role="tabpanel"
                            ...
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-12 col-md-6"><img class="img-fluid shadow rounded"
                                        src="{!! asset('images/builds/pc-builds.jpg') !!}" alt="Cheap PC"></div>
                                <a href="{!! route('laptop-list', ['type' => 'buisness']) !!}" class="my-4 mb-5 d-block font-weight-bold btn-open"><i
