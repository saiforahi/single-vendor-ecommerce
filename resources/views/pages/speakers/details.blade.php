...
@section('content')
    <section class="pcb-breadcrumb">
        ...
        <span><a href="{{route('home')}}">Home</a>
            ...
            <i class="fa fa-angle-right"></i><a href="index.html">Audioengine A5 Plus Classic</a></span>
    </section>
    <div class="container-fluid component-details">
        <div class="row">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item img-gradient active">
                            <img class="d-block img-fluid big-image lazy"
                                title="Audioengine A5 Plus Classic 150W Powered Bookshelf Speakers with Remote Control, Built in Analog Amplifier - Bamboo"
                                data-src="https://m.media-amazon.com/images/I/41gSKvJlZgL.jpg"
                                alt="Build My PC, PC Builder, Audioengine A5 Plus Classic">
                        </div>
                        <div class="carousel-item img-gradient">
                            <img class="d-block img-fluid big-image lazy"
                                title="Audioengine A5 Plus Classic 150W Powered Bookshelf Speakers with Remote Control, Built in Analog Amplifier - Bamboo"
                                data-src="https://m.media-amazon.com/images/I/41NllYSF7eL.jpg"
                                alt="Build My PC, PC Builder, Audioengine A5 Plus Classic">
                        </div>
                        <div class="carousel-item img-gradient">
                            <img class="d-block img-fluid big-image lazy"
                                title="Audioengine A5 Plus Classic 150W Powered Bookshelf Speakers with Remote Control, Built in Analog Amplifier - Bamboo"
                                data-src="https://m.media-amazon.com/images/I/318dFfHDUqL.jpg"
                                alt="Build My PC, PC Builder, Audioengine A5 Plus Classic">
                        </div>
                        <div class="carousel-item img-gradient">
                            <img class="d-block img-fluid big-image lazy"
                                title="Audioengine A5 Plus Classic 150W Powered Bookshelf Speakers with Remote Control, Built in Analog Amplifier - Bamboo"
                                data-src="https://m.media-amazon.com/images/I/41ZQr+vwtuL.jpg"
                                alt="Build My PC, PC Builder, Audioengine A5 Plus Classic">
                        </div>
                        <div class="carousel-item img-gradient">
                            <img class="d-block img-fluid big-image lazy"
                                title="Audioengine A5 Plus Classic 150W Powered Bookshelf Speakers with Remote Control, Built in Analog Amplifier - Bamboo"
                                data-src="https://m.media-amazon.com/images/I/41X2t1A0eUL.jpg"
                                alt="Build My PC, PC Builder, Audioengine A5 Plus Classic">
                        </div>
                        <div class="carousel-item img-gradient">
                            <img class="d-block img-fluid big-image lazy"
                                title="Audioengine A5 Plus Classic 150W Powered Bookshelf Speakers with Remote Control, Built in Analog Amplifier - Bamboo"
                                data-src="https://m.media-amazon.com/images/I/41y4QbYtFrL.jpg"
                                alt="Build My PC, PC Builder, Audioengine A5 Plus Classic">
                        </div>
                        <div class="carousel-item img-gradient">
                            <img class="d-block img-fluid big-image lazy"
                                title="Audioengine A5 Plus Classic 150W Powered Bookshelf Speakers with Remote Control, Built in Analog Amplifier - Bamboo"
                                data-src="https://m.media-amazon.com/images/I/41EL-BqXjXL.jpg"
                                alt="Build My PC, PC Builder, Audioengine A5 Plus Classic">
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-9 pl-md-5 pr-md-5">
                <h1>Audioengine A5 Plus Classic 150W Powered Bookshelf Speakers with Remote Control, Built in Analog
                    Amplifier - Bamboo</h1>
