                    ...
                    <table id="myTable" class="mt-3 table table-design">
                        ...
                        <tbody>
                            ...
                            <tr class="items" data-href="#">
                                ...
                                <td class="comp-details">
                                    ...
                                    <span class="table_span">
                                        ...
                                        <div class="detail">
                                            ...
                                            <div class="detail__value f_stock"> {{ $web_cam->product->stock }} </div>
                                        </div>
                                    </span>
                                    {{-- <span class="table_span">
                                ...
                                <td class="price">
                                    {{ $web_cam->product->price }} </td>

                                <td><a class="btn btn-primary component-btn"
                                        href="{{ route('webcams-details', ['id' => $web_cam->id]) }}" target="_blank">View
                                        Details</a></td>
                                <td class="remove"><a class="btn btn-danger component-add-btn" id="p_1"
                                        href="{{ route('add-web_cam-to-system', ['web_cam_id' => $web_cam->id]) }}"><i
