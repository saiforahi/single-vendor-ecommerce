                                    ...
                                    <div class="card-body">
                                        <div class="checkbox"> <label> <input id="0" type="checkbox"
                                                    ...
                                                    <div class="checkbox"> <label> <input id="{{ $loop->index + 1 }}"
                                                                ...
                                                                ({{ \App\Models\OpticalDrive::where('brand', $brand->brand)->count() }})
                                                            </span></label> </div>
                                                @endforeach
                                    </div>
                                </div>
                    ...
                    <table id="myTable" class="mt-3 table table-design">
                        ...
                        <tbody>
                            ...
                            <tr class="items" data-href="#">
                                ...
                                <td class="comp-details">
                                    ...
                                    <span class="table_span">
                                        ...
                                        <div class="detail">
                                            ...
                                            <div class="detail__value f_stock"> {{ $optical_drive->product->stock }} </div>
                                        </div>
                                    </span>
                                    {{-- <span class="table_span">
                                ...
                                <td class="price">
                                    {{ $optical_drive->product->price }} </td>

                                <td><a class="btn btn-primary component-btn"
                                        href="{{ route('optical-drives-details', ['id' => $optical_drive->id]) }}" target="_blank">View
                                        Details</a></td>
                                <td class="remove"><a class="btn btn-danger component-add-btn" id="p_1"
                                        href="{{ route('add-optical-drive-to-system', ['optical_drive_id' => $optical_drive->id]) }}"><i
    ...
    <script type="application/ld+json">
        {
         ...
         [
          ...
          "item":
           {
             "@id": "https://pcbuilder.net/product/optical-drive/",
             "name": "Optical Drive"
           }
          }
         ]
