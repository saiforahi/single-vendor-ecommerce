...
@section('content')
    <section class="pcb-breadcrumb">
        <h1><span>Select</span> Your Headphone</h1>
        <span><a href="{{ route('home') }}">Home</a>
            <i class="fa fa-angle-right"></i><a href="../index.html">Product</a>
            <i class="fa fa-angle-right"></i><a href="headphones-list">Headphone</a>
        </span>
    </section>
                                    ...
                                    <div class="card-body">
                                        <div class="checkbox"> <label> <input id="0" type="checkbox"
                                                    ...
                                                    <div class="checkbox"> <label> <input id="{{ $loop->index + 1 }}"
                                                                ...
                                                                ({{ \App\Models\HeadPhone::where('brand', $brand->brand)->count() }})
                                                            </span></label> </div>
                                                @endforeach
                                    </div>
                                </div>
                            ...
                            <div class="card panel-default">
                                ...
                                <div id="collapse3" class="collapse " role="tabpanel" aria-labelledby="heading3">
                                    <div class="card-body">
                                        ...
                                        <div class="checkbox"> <label> <input id="1" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Arctic Camo"> <span
                                                    class="ml-10">Arctic Camo (1) </span></label> </div>
                                        <div class="checkbox"> <label> <input id="2" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Black"> <span
                                                    class="ml-10">Black (345) </span></label> </div>
                                        <div class="checkbox"> <label> <input id="3" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Black / Beige"> <span
                                                    class="ml-10">Black / Beige (1) </span></label> </div>
                                        <div class="checkbox"> <label> <input id="4" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Black / Blue"> <span
                                                    class="ml-10">Black / Blue (12) </span></label> </div>
                                        ...
                                        <div class="checkbox"> <label> <input id="6" type="checkbox"
                                                    ...
                                                    class="ml-10">Black / Gray (5) </span></label> </div>
                                        ...
                                        <div class="checkbox"> <label> <input id="16" type="checkbox"
                                                    ...
                                                    class="ml-10">Black RBG (1) </span></label> </div>
                                        ...
                                        <div class="checkbox"> <label> <input id="18" type="checkbox"
                                                    ...
                                                    class="ml-10">Blue / Black (2) </span></label> </div>
                                        <div class="checkbox"> <label> <input id="19" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Bronze"> <span
                                                    class="ml-10">Bronze (1) </span></label> </div>
                                        <div class="checkbox"> <label> <input id="20" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Brown"> <span
                                                    class="ml-10">Brown (1) </span></label> </div>
                                        ...
                                        <div class="checkbox"> <label> <input id="23" type="checkbox"
                                                    ...
                                                    class="ml-10">Gold / Black (7) </span></label> </div>
                                        ...
                                        <div class="checkbox"> <label> <input id="26" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Gray / Brown"> <span
                                                    class="ml-10">Gray / Brown (1) </span></label> </div>
                                        <div class="checkbox"> <label> <input id="27" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Green"> <span
                                                    class="ml-10">Green (8) </span></label> </div>
                                        ...
                                        <div class="checkbox"> <label> <input id="29" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Grey / Black "> <span
                                                    class="ml-10">Grey / Black (1) </span></label> </div>
                                        <div class="checkbox"> <label> <input id="30" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Ivory"> <span
                                                    class="ml-10">Ivory (1) </span></label> </div>
                                        <div class="checkbox"> <label> <input id="31" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Orange"> <span
                                                    class="ml-10">Orange (3) </span></label> </div>
                                        <div class="checkbox"> <label> <input id="32" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Orange / Gray"> <span
                                                    class="ml-10">Orange / Gray (2) </span></label> </div>
                                        ...
                                        <div class="checkbox"> <label> <input id="37" type="checkbox"
                                                    ...
                                                    class="ml-10">Red / Black (8) </span></label> </div>
                                        ...
                                        <div class="checkbox"> <label> <input id="54" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="White / Violet"> <span
                                                    class="ml-10">White / Violet (1) </span></label> </div>
                                        <div class="checkbox"> <label> <input id="55" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Yellow"> <span
                                                    class="ml-10">Yellow (4) </span></label> </div>
                                        <div class="checkbox"> <label> <input id="56" type="checkbox"
                                                    onclick="f_color(this.id);" class="option-input checkbox color"
                                                    name="filter['color']" value="Yellow / Purpal"> <span
                                                    class="ml-10">Yellow / Purpal (1) </span></label> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-10">
                    <div class="tool-design">
                        <div class="upper-box">
                            ...
                            <div class="action-box">
                                ...
                                <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search Headphone....."
                                    title="Search....">
                            </div>
                    ...
                    <table id="myTable" class="mt-3 table table-design">
                        <thead>
                            ...
                            <tbody>
                                @foreach ($head_phones as $head_phone)
                                <tr class="items" data-href="#">
                                    ...
                                    <td class="box">
                                        <div class="logo-name">
                                            <div class="item-logo">
                                                <?php $images = $head_phone->product->getMedia('main_image'); ?>
                                                <img src="{{ count($images) > 0 ? $images[0]->getUrl('main_image') : asset('images/dummy-thumbnail') }}"
                                                    ...
                                                    title="{{ $head_phone->name }}" alt="{{ $head_phone->name }}">
                                    ...
                                    <td class="comp-details">
                                        ...
                                        <span class="table_span">
                                            ...
                                            <div class="detail">
                                                ...
                                                <div class="detail__value f_stock"> {{ $head_phone->product->stock }} </div>
                                            </div>
                                        </span>
                                        {{-- <span class="table_span">
                                            ...
                                            <div class="detail">
                                                ...
                                                <div class="detail__value f_frequency"> 15 Hz - 25 kHz </div>
                                            </div>
                                            <div class="detail">
                                    ...
                                    <td class="price">
                                        {{ $head_phone->product->price }} </td>

                                    <td><a class="btn btn-primary component-btn"
                                            href="{{ route('headphones-details', ['id' => $head_phone->id]) }}" target="_blank">View
                                            Details</a></td>
                                    <td class="remove"><a class="btn btn-danger component-add-btn" id="p_1"
                                            href="{{ route('add-headphone-to-system', ['head_phone_id' => $head_phone->id]) }}"><i
    ...
    <script type="application/ld+json">
        {
            ...
            "itemListElement": [{
                ...
                },
                {
                    ...
                    "position": 3,
                    "item": {
                        "@id": "https://pcbuilder.net/product/headphone/",
                        "name": "Headphone"
                    }
                }
            ]
