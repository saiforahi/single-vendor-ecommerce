                                    ...
                                    <div class="card-body">
                                        <div class="checkbox"> <label> <input id="0" type="checkbox"
                                                    ...
                                                    <div class="checkbox"> <label> <input id="{{ $loop->index + 1 }}"
                                                                ...
                                                                ({{ \App\Models\WirelessNetworkAdapter::where('brand', $brand->brand)->count() }})
                                                            </span></label> </div>
                                                @endforeach
                                    </div>
                                </div>
                    ...
                    <table id="myTable" class="mt-3 table table-design">
                        ...
                        <tbody>
                            ...
                            <tr class="items" data-href="#">
                                ...
                                <td class="comp-details">
                                    ...
                                    <span class="table_span">
                                        ...
                                        <div class="detail">
                                            ...
                                            <div class="detail__value f_stock"> {{ $wireless_network_adapter->product->stock }} </div>
                                        </div>
                                    </span>
                                    {{-- <span class="table_span">
                                ...
                                <td class="price">
                                    {{ $wireless_network_adapter->product->price }} </td>

                                <td><a class="btn btn-primary component-btn"
                                        href="{{ route('wireless-network-adapter-details', ['id' => $wireless_network_adapter->id]) }}" target="_blank">View
                                        Details</a></td>
                                <td class="remove"><a class="btn btn-danger component-add-btn" id="p_1"
                                        href="{{ route('add-wireless_network_adapter-to-system', ['wireless_network_adapter_id' => $wireless_network_adapter->id]) }}"><i
