...
Route::prefix('casecoolers')->group(function(){
    ...
    Route::get('/specification/list/{type}',[App\Http\Controllers\api\CaseCoolerController::class,'get_laptop_create_options']);

    Route::get('/images/{id}',[App\Http\Controllers\api\CaseCoolerController::class,'get_all_media']);
